...
// numElem: El número de lemeentos actuales de la cola
...
int Heap_compare_wakeup(int uno, int dos) {
  return processTable[dos].whenToWakeUp - processTable[uno].whenToWakeUp; // Descomentar cuando se pida...
	//return processTable[dos].whenToWakeUp-processTable[uno].whenToWakeUp; 																// Comentar cuando se pida...
}
