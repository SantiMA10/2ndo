    ...
    public class Model {
        ...
        static void ResetModel() {
            ...
            employees = new List<Employee> {
                ...
                new Employee ("Alvaro", "Bernardez", new DateTime(1973,12,09), "985 012", "bernardo@uniovi.es", "Asturias", offices[1]),
    		    };

            departments = new List<Department> {
			    new Department ( "Mathematics", new List<Employee> {employees[4]} ),
			    new Department ( "Computer Science",new List<Employee> {employees[1], employees[2], employees[6]}),
            ...
            employees[1].Department = employees[2].Department = employees[6].Department = departments[1];
            ...
            phoneCalls = new List<PhoneCall> {
                ...
                new PhoneCall { SourceNumber = "985 012", DestinationNumber = "985 001", Seconds = 63, Date = new DateTime(2011,	3,	8,	14,	0,	0) },
			    new PhoneCall { SourceNumber = "985 012", DestinationNumber = "985 005", Seconds = 07, Date = new DateTime(2011,	4,	8,	14,	37,	0) },
                ...
                new PhoneCall { SourceNumber = "985 012", DestinationNumber = "985 001", Seconds = 32, Date = new DateTime(2011,	7,	8,	14,	0,	0) },
