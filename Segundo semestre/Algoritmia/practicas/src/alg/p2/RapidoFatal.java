...
/** Este programa sirve para ordenar n elementos con un algoritmo QUICKSORT
	Pero como selecciona como pivote el elemento primero de la partici�n, si se
	le mete el array ordenado tiene un comportamiento fatal (cuadr�tico). 
 */
...
//		Vector.escribe (v);
	...
	/** Deja el	pivote en una posici�n tal que a su izquierda no hay 
		ning�n mayor, ni a la derecha ning�n menor.
