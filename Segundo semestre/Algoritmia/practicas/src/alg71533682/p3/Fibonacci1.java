...
public class Fibonacci1
{
	...
	/** Primera solución iterativa con complejidad temporal O(n)
	 */
	...
	/** Segunda solución con complejidad temporal O(n) y 
	 * que utiliza un vector.
	 * Este algoritmo se va a ver más adelante como un caso muy 
	...
	/** Segunda versión recursiva, 
	 * de ecuación T(n) = T(n-1) + T(n-2) + O(1), 
	 ...
	 * sumade los tiempos los dos tamaños precedentes:(n-1) y (n-2).
	 */
